...
func TestConvertHexAndBin(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "invalid hex - keeps word, removes marker",
			input:    []string{"XYZ", "(hex)", "test"},
			expected: []string{"XYZ", "test"},
		},
		{
			name:     "invalid bin - keeps word, removes marker",
			input:    []string{"102", "(bin)", "test"},
			expected: []string{"102", "test"},
		},
		{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := transform.ConvertHexAndBin(tt.input)
...
func TestConvertHexAndBinEdgeCases(t *testing.T) {
	// Test empty slice
	result := transform.ConvertHexAndBin([]string{})
	if len(result) != 0 {
		t.Errorf("Expected empty slice, got %v", result)
	}

	// Test single element
	result = transform.ConvertHexAndBin([]string{"test"})
...
func TestApplyCaseRules(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := transform.ApplyCaseRules(tt.input)
			if !reflect.DeepEqual(result, tt.expected) {
...
func TestCapitalize(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.input, func(t *testing.T) {
			result := transform.Capitalize(tt.input)
...
func TestParseMarkerCount(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result, valid := transform.ParseMarkerCount(tt.input)
			if valid != tt.valid {
...
func TestFixArticles(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := transform.FixArticles(tt.input)
			for i := range result {
...
func TestApplyPunctuationRules(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := transform.ApplyPunctuationRules(tt.input)
			if result != tt.expected {
...
func TestFixQuotes(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := transform.FixQuotes(tt.input)
			if result != tt.expected {
